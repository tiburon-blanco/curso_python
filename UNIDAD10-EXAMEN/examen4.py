...
for i in range(5):
    ...
    # MIENTRAS ALLA CLIENTE, hacer con WHILE


    venta = True
    while venta:
        print("Que tipo de animal desea comprar?") 
        ...
        if tipo == 'C':
            ...
            if hay_stock:
                ...
                cantidad_animales = cantidad_animales + 1
                print("El monto de su compra de chango es: ", precio)

        
        seguir = input("Desea hacer otra compra (S/N)")
        if seguir != "S":
            venta = False
