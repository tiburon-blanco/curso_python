class Carrera():
    def __init__(self):
        ...
        self.cantidad = int(
            input("Agrege que cantidad de vehiculos correran: "))
        print(" Se correra una carrera de: ", self.pista,
              "metros. Y participaran: ", self.cantidad, "de vehiculos.")
